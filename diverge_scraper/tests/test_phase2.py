...
class TestCapitulationDetection(unittest.TestCase):
    ...
    def setUp(self):
        from diverge_scraper.text_features import detect_capitulation
...
class TestConvictionHedgeRatio(unittest.TestCase):
    ...
    def setUp(self):
        from diverge_scraper.text_features import conviction_hedge_ratio
...
class TestSarcasmDetection(unittest.TestCase):
    ...
    def setUp(self):
        from diverge_scraper.text_features import detect_sarcasm
    ...
    def test_irony_adjusted_dampens_toward_zero(self):
        from diverge_scraper.text_features import irony_adjusted
...
class TestLanguageDetection(unittest.TestCase):
    ...
    def setUp(self):
        from diverge_scraper.text_features import detect_language
        self.detect = detect_language

    def test_devanagari_text_flagged_as_mixed(self):
        text = "यह स्टॉक बहुत अच्छा है। मुझे खरीदना चाहिए।"
...
class TestPeriodicityAnalysis(unittest.TestCase):
    ...
    def _get_stats_for_ticker(self, ticker: str):
        from diverge_scraper.periodicity_analysis import (
    ...
    def test_minimum_sample_guard_skips_sparse_windows(self):
        ...
        """
        from diverge_scraper.periodicity_analysis import analyse_ticker, MIN_POSTS_PER_WINDOW
    ...
    def test_run_writes_to_db(self):
        ...
        from diverge_scraper import periodicity_analysis
